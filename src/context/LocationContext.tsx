...
export const branchData: Record<BranchId, Branch> = {
  ...
  alkapuri: {
    ...
    forWhom: 'Girls Only',
    address: 'Rc dutt road Punam apartment 5th floor near mahalaxmi provision store alkapuri vadodara 390007',
    phone: '918780865191',
    ...
    images: [
      ...
      'https://iili.io/CkDqrCB.jpg',
      'https://iili.io/CkDBJ3X.jpg',
      'https://iili.io/CkDBU9s.jpg',
      'https://iili.io/CkDnSjf.jpg',
      'https://iili.io/CkDx3f2.jpg',
      'https://iili.io/CkDzzpn.jpg'
    ],
    pricing: [
