  ...
  return (
    <div className="fixed bottom-6 right-6 flex flex-col items-center space-y-4 z-40">
      <motion.button
        ...
        className="bg-amber-500 text-white p-3 md:p-3 rounded-full shadow-lg hover:bg-amber-600 transition-colors hidden md:flex items-center justify-center"
      ...
      <motion.a
        ...
        className="bg-violet-900 text-white p-3 rounded-full shadow-lg hover:bg-violet-800 transition-colors flex items-center justify-center"
        aria-label="Call Us"
      >
